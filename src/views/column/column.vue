<template>
    <div id="column-app">
        ...
        <article>
            ...
            <section class="r-column-nav">
                <ivu-breadcrumb separator="<b class='r-breadcrumb-separator'>/</b>">
                    <ivu-breadcrumbItem to="/articles">Articles</ivu-breadcrumbItem>
                    <ivu-breadcrumbItem :to="{ name:'Column',params:{ cvId: $route.params.cvId } }">{{ column.info.title }}</ivu-breadcrumbItem>
                </ivu-breadcrumb>
            </section>
